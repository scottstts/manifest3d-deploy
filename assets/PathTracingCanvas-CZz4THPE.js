...
`,X=w(Te(),1),br={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
...
`,Ga=class extends hi{onBeforeRender(){this.setDefine(`FEATURE_DOF`,this.physicalCamera.bokehSize===0?0:1),this.setDefine(`FEATURE_BACKGROUND_MAP`,+!!this.backgroundMap),this.setDefine(`FEATURE_FOG`,+!!this.materials.features.isUsed(`FOG`))}constructor(e){super({transparent:!0,depthWrite:!1,defines:{FEATURE_MIS:1,FEATURE_RUSSIAN_ROULETTE:1,FEATURE_DOF:1,FEATURE_BACKGROUND_MAP:0,FEATURE_FOG:1,RANDOM_TYPE:2,CAMERA_TYPE:0,DEBUG_MODE:0,ATTR_NORMAL:0,ATTR_TANGENT:1,ATTR_UV:2,ATTR_COLOR:3,MATERIAL_PIXELS:47},uniforms:{resolution:{value:new S},opacity:{value:1},bounces:{value:10},transmissiveBounces:{value:10},filterGlossyFactor:{value:0},physicalCamera:{value:new Ti},cameraWorldMatrix:{value:new C},invProjectionMatrix:{value:new C},bvh:{value:new mr},attributesArray:{value:new Gi},materialIndexAttribute:{value:new fr},materials:{value:new ea},textures:{value:new ia().texture},lights:{value:new Hi},iesProfiles:{value:new ia(360,180,{type:P,wrapS:le,wrapT:le}).texture},environmentIntensity:{value:1},environmentRotation:{value:new C},envMapInfo:{value:new Ai},backgroundBlur:{value:0},backgroundMap:{value:null},backgroundAlpha:{value:1},backgroundIntensity:{value:1},backgroundRotation:{value:new C},seed:{value:0},sobolTexture:{value:null},stratifiedTexture:{value:new ua},stratifiedOffsetTexture:{value:new _a(64,1)}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};fo.BlurDirectionX=new S(1,0),fo.BlurDirectionY=new S(0,1);var po={},mo={},ho=`manifest3dPathTracingBloomRole`;function go({assets:e,jointPreviewPosesByInstance:t,materialAnimationValuesByInstance:n,scene:r,worldMode:i}){So(r),yo(r,i);let a=e.map(e=>xo(r,e,{jointPreviewPoses:t[e.instanceId]??po,materialAnimationValues:n[e.instanceId]??mo}));return r.updateMatrixWorld(!0),()=>{for(let e of a)r.remove(e.object),je(e.sourceObject);So(r)}}function _o(e,{emissionGain:t=$.emissionGain}={}){let n=e,r=Do(n.emissive,`#000000`),i=Oo(r)?0:(n.emissiveIntensity??0)*t,a=new v({alphaMap:n.alphaMap??null,alphaTest:n.alphaTest??0,aoMap:n.aoMap??null,color:Do(n.color,`#ffffff`),emissive:r,emissiveIntensity:i,envMap:n.envMap??null,map:n.map??null,metalness:n.metalness??0,metalnessMap:n.metalnessMap??null,name:n.name,normalMap:n.normalMap??null,opacity:n.opacity,roughness:n.roughness??1,roughnessMap:n.roughnessMap??null,side:n.side,transparent:n.transparent||n.opacity<1});return a.depthTest=n.depthTest,a.depthWrite=n.depthWrite,a.visible=n.visible,a}function vo(e,t={}){let n=new Map,r=new Set;e.traverse(e=>{if(ko(e)){if(Array.isArray(e.material)){e.material=e.material.map(e=>(r.add(e),Eo(e,n,t)));return}r.add(e.material),e.material=Eo(e.material,n,t)}});for(let e of r)e.dispose();return[...n.values()]}function yo(e,t){let n=Ne(t);e.background=new k(n.backgroundColor),e.fog=new l(n.fog.color,n.fog.density);let r=new f(n.lights.hemisphere.skyColor,n.lights.hemisphere.groundColor,n.lights.hemisphere.intensity);e.add(r),e.environment=bo(t),e.environmentIntensity=n.lights.fill.intensity*$.environmentFillIntensity;let i=new b(n.lights.key.color,n.lights.key.intensity);i.name=`Manifest3D path tracing key directional light`,i.position.set(...n.lights.key.position),i.castShadow=!0,e.add(i);let a=new c(new D(500,500),new v({color:n.ground.color,metalness:n.ground.metalness,roughness:n.ground.roughness}));a.name=`Manifest3D path tracing ground plane`,a.receiveShadow=!0,a.rotation.x=-Math.PI/2,e.add(a)}function bo(e){let t=Ne(e),n=new to(32);return n.topColor.set(t.lights.hemisphere.skyColor),n.bottomColor.set(t.ground.color).lerp(new k(t.lights.fill.color),.35),n.exponent=1.7,n.update(),n}function xo(e,t,{jointPreviewPoses:n,materialAnimationValues:r}){let i=Oe(t.asset);Pe(i,n),De(i,r),vo(i.group);let a=To(i.group),o=new m,s=new m;return o.name=`${t.asset.name} path tracing viewport root`,o.userData[ho]=`asset`,o.position.set(t.transform.position[0]+a.anchorOffset.x,t.transform.position[1]+a.anchorOffset.y,t.transform.position[2]+a.anchorOffset.z),o.rotation.set(...t.transform.rotation),o.scale.set(...t.transform.scale),s.position.copy(a.center).multiplyScalar(-1),s.add(i.group),o.add(s),e.add(o),{object:o,sourceObject:i.group}}function So(e){for(let t of[...e.children])e.remove(t),wo(t);Co(e.background)&&e.background.dispose(),Co(e.environment)&&e.environment.dispose(),e.background=null,e.environment=null,e.environmentIntensity=1,e.fog=null}function Co(e){return!!e?.isTexture}function wo(e){e.traverse(e=>{if(ko(e)){e.geometry.dispose();let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t)e.dispose()}})}function To(e){e.updateWorldMatrix(!0,!0);let t=new F().setFromObject(e);if(t.isEmpty()){let e=new s;return{anchorOffset:e.clone(),center:e}}let n=t.getCenter(new s),r=n.clone();return r.y-=t.min.y,{anchorOffset:r,center:n}}function Eo(e,t,n){let r=t.get(e);if(r)return r;let i=_o(e,n);return t.set(e,i),i}function Do(e,t){return e?.isColor?e.clone():new k(t)}function Oo(e){return e.r<=1e-6&&e.g<=1e-6&&e.b<=1e-6}function ko(e){return e.isMesh===!0}function Ao(e){let t=e;for(;t;){if(t.userData[ho]===`asset`)return!0;t=t.parent}return!1}var jo=`
  varying vec2 vUv;
...
`;function Qo(e=$.denoise){let t=new te,n=new ee(-1,1,1,-1,0,1),r=new c(new D(2,2)),i=new O({depthTest:!1,depthWrite:!1,fragmentShader:Yo,name:`Manifest3D path tracing denoise firefly clamp material`,uniforms:{tGuideMaterial:{value:null},tInput:{value:null},uMinRatio:{value:e.fireflyMinRatio},uTexelSize:{value:new S(1,1)},uThresholdSigma:{value:e.fireflyClampSigma}},vertexShader:Uo}),a=new O({depthTest:!1,depthWrite:!1,fragmentShader:Xo,name:`Manifest3D path tracing denoise adaptive à-trous material`,uniforms:{tGuideGeometry:{value:null},tGuideMaterial:{value:null},tInput:{value:null},uColorPhi:{value:e.colorPhi},uDepthPhi:{value:e.depthPhi},uDepthRelativePhi:{value:e.depthRelativePhi},uDetailProtection:{value:e.detailProtection},uMaterialPhi:{value:e.materialPhi},uNormalPhi:{value:e.normalPhi},uStepWidth:{value:1},uTexelSize:{value:new S(1,1)},uTransparencyProtection:{value:e.transparencyProtection}},vertexShader:Uo}),o=new O({depthTest:!1,depthWrite:!1,fragmentShader:Zo,name:`Manifest3D path tracing denoise final detail composite material`,uniforms:{tFiltered:{value:null},tFirefly:{value:null},tGuideGeometry:{value:null},tGuideMaterial:{value:null},tRaw:{value:null},uDepthPhi:{value:e.depthPhi},uDepthRelativePhi:{value:e.depthRelativePhi},uDetailProtection:{value:e.detailProtection},uTexelSize:{value:new S(1,1)},uTransparencyProtection:{value:e.transparencyProtection}},vertexShader:Uo});t.add(r);let s=1,l=1,u=!1,d=new Map,f=fs(s,l,`geometry`),p=fs(s,l,`material`),m=ds(s,l,`firefly`),h=ds(s,l,`ping-a`),g=ds(s,l,`ping-b`),_=ds(s,l,`composite`);function v(){f.dispose(),p.dispose(),m.dispose(),h.dispose(),g.dispose(),_.dispose()}function y(){for(let e of d.values())e.geometry.dispose(),e.material.dispose();d.clear()}function b(e,t,n){let r=Math.max(1,Math.floor(e*n)),c=Math.max(1,Math.floor(t*n));s===r&&l===c||(s=r,l=c,f.setSize(s,l),p.setSize(s,l),m.setSize(s,l),h.setSize(s,l),g.setSize(s,l),_.setSize(s,l),i.uniforms.uTexelSize.value.set(1/s,1/l),a.uniforms.uTexelSize.value.set(1/s,1/l),o.uniforms.uTexelSize.value.set(1/s,1/l))}function x(){u=!1,y()}function C(){v(),y(),i.dispose(),a.dispose(),o.dispose(),r.geometry.dispose()}function w({camera:t,inputTexture:n,renderer:r,scene:s}){if(u)return $o(n);let c=r.getRenderTarget(),l=s.overrideMaterial,d=s.background,v=r.autoClear,y=new k,b=r.getClearAlpha();r.getClearColor(y);try{if(r.autoClear=!0,s.overrideMaterial=null,s.background=null,T(t),E(r,s,t,f,`geometry`),as(r)||(E(r,s,t,p,`material`),as(r))||(i.uniforms.tGuideMaterial.value=p.texture,i.uniforms.tInput.value=n,A(r,i,m),as(r)))return u=!0,$o(n);a.uniforms.tGuideGeometry.value=f.texture,a.uniforms.tGuideMaterial.value=p.texture;let c=m.texture,l=h;for(let t of ns(e.atrousPasses)){if(a.uniforms.tInput.value=c,a.uniforms.uStepWidth.value=t,A(r,a,l),as(r))return u=!0,$o(n);c=l.texture,l=l===h?g:h}return o.uniforms.tFiltered.value=c,o.uniforms.tFirefly.value=m.texture,o.uniforms.tGuideGeometry.value=f.texture,o.uniforms.tGuideMaterial.value=p.texture,o.uniforms.tRaw.value=n,A(r,o,_),as(r)?(u=!0,$o(n)):{status:`denoised`,texture:_.texture}}finally{s.overrideMaterial=l,s.background=d,r.setRenderTarget(c),r.setClearColor(y,b),r.autoClear=v}}function T(t){let n=is(e.depthPhi,t.far);for(let e of d.values())e.geometry.uniforms.uCameraFar.value=t.far,e.material.uniforms.uCameraFar.value=t.far;a.uniforms.uDepthPhi.value=n,o.uniforms.uDepthPhi.value=n}function E(e,t,n,r,i){let a=ne(t,i);try{i===`geometry`?e.setClearColor(8421631,1):e.setClearColor(new k(0,1,0),0),e.setRenderTarget(r),e.clear(!0,!0,!0),e.render(t,n)}finally{us(a)}}function ne(e,t){let n=[];return e.traverse(e=>{ps(e)&&(n.push({material:e.material,object:e}),e.material=Array.isArray(e.material)?e.material.map(e=>re(e,t)):re(e.material,t))}),n}function re(e,t){let n=d.get(e);return n||(n=os(e),d.set(e,n)),t===`geometry`?n.geometry:n.material}function A(e,i,a){r.material=i,e.setRenderTarget(a),e.clear(!0,!1,!1),e.render(t,n)}return{dispose:C,render:w,reset:x,setSize:b}}function $o(e){return{status:`error`,texture:e}}function es({enabled:e,maxSamples:t,sampleCount:n}){return e&&t>0&&n>=t}function ts(e){return e!==0}function ns(e){let t=Math.max(0,Math.min(Vo,Math.floor(e)));return Array.from({length:t},(e,t)=>2**t)}function rs(e){return(Math.max(1,Math.floor(Math.abs(e)))*16807%(Ho-1)+1)/Ho}function is(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?.001:Math.max(e/t,1e-6)}function as(e){return ts(e.getContext().getError())}function os(e){let t=e,n=ss(t),r=new O({depthTest:t.depthTest,depthWrite:!0,fragmentShader:Ko,name:`Manifest3D path tracing denoise geometry guide material`,side:t.side,transparent:!1,uniforms:ce.clone(n),vertexShader:Wo,visible:t.visible}),i=new O({depthTest:t.depthTest,depthWrite:!0,fragmentShader:qo,name:`Manifest3D path tracing denoise material guide material`,side:t.side,transparent:!1,uniforms:ce.clone({...n,uEmissiveProtection:{value:cs(t)},uObjectKey:{value:0},uRoughness:{value:t.roughness??1},uTransparent:{value:t.transparent||t.opacity<.999?1:0}}),vertexShader:Wo,visible:t.visible});return r.onBeforeRender=(e,t,n)=>{r.uniforms.uCameraFar.value=ls(n)},i.onBeforeRender=(e,t,n,r,a)=>{i.uniforms.uCameraFar.value=ls(n),i.uniforms.uObjectKey.value=rs(a.id)},{geometry:r,material:i}}function ss(e){return{tAlphaMap:{value:e.alphaMap??null},tColorMap:{value:e.map??null},uAlphaTest:{value:e.alphaTest??0},uCameraFar:{value:80},uOpacity:{value:e.opacity??1},uUsesAlphaMap:{value:+!!e.alphaMap},uUsesColorMap:{value:+!!e.map}}}function cs(e){let t=e.emissive??new k(0,0,0),n=e.emissiveIntensity??0,r=t.r*.2126+t.g*.7152+t.b*.0722;return Math.min(1,r*Math.max(n,0))}function ls(e){return e instanceof u?e.far:80}function us(e){for(let t of e)t.object.material=t.material}function ds(e,t,n){let r=new j(e,t,{depthBuffer:!1,format:I,magFilter:N,minFilter:N,stencilBuffer:!1,type:P});return r.texture.name=`Manifest3D path tracing denoise ${n}`,r.texture.colorSpace=``,r}function fs(e,t,n){let r=new j(e,t,{depthBuffer:!0,format:I,magFilter:d,minFilter:d,stencilBuffer:!1,type:P});return r.texture.name=`Manifest3D path tracing denoise ${n} guide`,r.texture.colorSpace=``,r}function ps(e){return e.isMesh===!0}function ms(e,t,n=`idle`){let r=`${e} / ${t} samples`;return n===`denoising`?`${r} (denoising)`:n===`denoised`?`${r} (denoised)`:n===`not-denoised`?`${r} (not denoised)`:n===`not-denoised-error`?`${r} (not denoised - error)`:r}function hs({maxSamples:e,needsSceneUpload:t,sampleCount:n}){return t||n<e}var gs=`manifest3d:pathtracer-max-samples`,_s=$.maxSampleOptions[0];function vs(){return[...$.maxSampleOptions]}function ys(){if(typeof window>`u`)return _s;try{return xs(window.localStorage.getItem(gs))}catch{return _s}}function bs(e){if(!(typeof window>`u`))try{window.localStorage.setItem(gs,Ss(e))}catch{}}function xs(e){let t=typeof e==`number`?e:Number.parseInt(String(e),10);return Cs(t)?t:_s}function Ss(e){return String(e)}function Cs(e){return $.maxSampleOptions.includes(e)}function ws(e){let t=e.getSize(new S);return e.setScissorTest(!1),e.setViewport(0,0,t.x,t.y),t}var Ts=we(),Es=co();function Ds({assets:e,cameraSnapshot:t,denoiseEnabled:n,jointPreviewPosesByInstance:r,leftPanelOcclusionWidth:i,materialAnimationValuesByInstance:a,rightPanelOcclusionWidth:o,worldMode:s}){let c=(0,X.useRef)(null),l=(0,X.useRef)(null),d=(0,X.useRef)(null),f=(0,X.useRef)(null),p=(0,X.useRef)(null),m=(0,X.useRef)(null),h=(0,X.useRef)(!1),g=(0,X.useRef)(null),_=(0,X.useRef)(null),v=(0,X.useRef)(null),y=(0,X.useMemo)(()=>vs(),[]),[b,x]=(0,X.useState)(()=>ys()),S=(0,X.useRef)(b),C=(0,X.useRef)(t??Es),w=(0,X.useRef)(i),T=(0,X.useRef)(o),E=(0,X.useRef)({height:1,width:1}),ee=(0,X.useRef)(n),[D,O]=(0,X.useState)({height:1,width:1}),k=(0,X.useMemo)(()=>Ee(D.width,D.height,window.devicePixelRatio),[D.height,D.width]);return(0,X.useEffect)(()=>{let e=l.current;if(!e)return;let t=new ResizeObserver(([e])=>{let{height:t,width:n}=e.contentRect;O({height:Math.max(1,Math.floor(t)),width:Math.max(1,Math.floor(n))})});return t.observe(e),()=>t.disconnect()},[]),(0,X.useEffect)(()=>{let e=c.current;if(!e)return;let t=new _e({alpha:!1,antialias:!0,canvas:e,powerPreference:`high-performance`}),n=new u(38,1,.1,80),r=new te,i=new so(t),a=new jr,o=new Ar,s=new Or(t),l=Qo(),d=Po();return t.autoClear=!0,t.outputColorSpace=he,t.toneMapping=4,t.toneMappingExposure=$.toneMappingExposure,i.bounces=$.bounces,i.filterGlossyFactor=$.filterGlossyFactor,i.minSamples=$.minSamples,i.renderDelay=$.renderDelayMs,i.fadeDuration=0,i.dynamicLowRes=!1,i.lowResScale=1,i.renderScale=1,i.rasterizeScene=!1,i.renderToCanvas=!1,i.tiles.set(...$.tiles),i.textureSize.set($.maxTextureSize,$.maxTextureSize),s.addPass(a),s.addPass(o),p.current={assetBloomPipeline:d,camera:n,composer:s,denoisePipeline:l,pathTracer:i,renderer:t,scene:r,texturePass:a},h.current=!0,ks(v),()=>{m.current?.(),m.current=null,p.current=null,i.dispose(),s.dispose(),l.dispose(),d.dispose(),a.dispose(),o.dispose(),t.dispose()}},[]),(0,X.useEffect)(()=>{E.current=D;let e=p.current;e&&(As(e,D,k),js({lastPublishedSampleCounterTextRef:g,leftPanelOcclusionWidth:w.current,maxSamples:S.current,rightPanelOcclusionWidth:T.current,runtime:e,sampleCounterRef:f,snapshot:C.current,viewportSize:D}),ks(v))},[k,D]),(0,X.useEffect)(()=>{C.current=t??Es,w.current=i,T.current=o;let e=p.current;e&&(js({lastPublishedSampleCounterTextRef:g,leftPanelOcclusionWidth:i,maxSamples:S.current,rightPanelOcclusionWidth:o,runtime:e,sampleCounterRef:f,snapshot:C.current,viewportSize:E.current}),ks(v))},[t,i,o]),(0,X.useEffect)(()=>{let t=p.current;t&&(m.current?.(),m.current=go({assets:e,jointPreviewPosesByInstance:r,materialAnimationValuesByInstance:a,scene:t.scene,worldMode:s}),h.current=!0,Os({lastPublishedSampleCounterTextRef:g,maxSamples:S.current,sampleCount:0,sampleCounterRef:f}),ks(v))},[e,r,a,s]),(0,X.useEffect)(()=>{ee.current=n,ks(v)},[n]),(0,X.useEffect)(()=>{S.current=b,bs(b);let e=p.current;Os({lastPublishedSampleCounterTextRef:g,maxSamples:b,sampleCount:e?Math.min(b,Math.floor(e.pathTracer.samples)):0,sampleCounterRef:f}),ks(v)},[b]),(0,X.useEffect)(()=>{let e=!1;function t(){e||_.current!==null||(_.current=requestAnimationFrame(n))}function n(){_.current=null;let n=p.current;if(!n||e)return;h.current&&(Ms(n.camera,C.current,E.current,w.current,T.current),Ns(n),h.current=!1,Os({lastPublishedSampleCounterTextRef:g,maxSamples:S.current,sampleCount:0,sampleCounterRef:f}));let r=S.current;n.pathTracer.samples<r&&n.pathTracer.renderSample();let i=Math.min(r,Math.floor(n.pathTracer.samples)),a=n.pathTracer.samples>=r;es({enabled:$.denoise.enabled&&ee.current,maxSamples:r,sampleCount:n.pathTracer.samples})&&Os({denoiseStatus:`denoising`,lastPublishedSampleCounterTextRef:g,maxSamples:r,sampleCount:i,sampleCounterRef:f});let o=Ps(n,ee.current,r);ws(n.renderer),n.texturePass.map=n.assetBloomPipeline.render({camera:n.camera,inputTexture:o.texture,renderer:n.renderer,scene:n.scene}),n.composer.render(),Os({denoiseStatus:o.denoiseStatus??(a?`not-denoised`:`idle`),lastPublishedSampleCounterTextRef:g,maxSamples:r,sampleCount:i,sampleCounterRef:f}),hs({maxSamples:r,needsSceneUpload:h.current,sampleCount:n.pathTracer.samples})&&t()}return v.current=t,t(),()=>{e=!0,v.current=null,_.current!==null&&(cancelAnimationFrame(_.current),_.current=null)}},[]),(0,Ts.jsxs)(`div`,{className:`pathtracing-stage`,ref:l,children:[(0,Ts.jsx)(`canvas`,{ref:c}),(0,Ts.jsxs)(`details`,{className:`pathtracing-sample-counter`,onBlur:e=>{let t=e.relatedTarget;(!(t instanceof Node)||!e.currentTarget.contains(t))&&(e.currentTarget.open=!1)},ref:d,children:[(0,Ts.jsx)(`summary`,{"aria-haspopup":`menu`,className:`pathtracing-sample-counter__button`,children:(0,Ts.jsx)(`span`,{"aria-live":`polite`,ref:f,role:`status`,children:ms(0,b)})}),(0,Ts.jsx)(`div`,{className:`pathtracing-sample-counter__menu`,role:`menu`,children:y.map(e=>(0,Ts.jsxs)(`button`,{"aria-checked":e===b,className:e===b?`is-selected`:void 0,onClick:()=>{x(e),d.current&&(d.current.open=!1)},role:`menuitemradio`,type:`button`,children:[e,` samples`]},e))})]})]})}function Os({denoiseStatus:e=`idle`,lastPublishedSampleCounterTextRef:t,maxSamples:n,sampleCount:r,sampleCounterRef:i}){let a=ms(r,n,e);t.current!==a&&(t.current=a,i.current&&(i.current.textContent=a))}function ks(e){e.current?.()}function As(e,t,n){let r=t.width,i=t.height;e.renderer.setPixelRatio(n),e.renderer.setSize(r,i,!1),e.composer.setPixelRatio(n),e.composer.setSize(r,i),e.assetBloomPipeline.setSize(r,i,n),e.denoisePipeline.setSize(r,i,n)}function js({lastPublishedSampleCounterTextRef:e,leftPanelOcclusionWidth:t,maxSamples:n,rightPanelOcclusionWidth:r,runtime:i,sampleCounterRef:a,snapshot:o,viewportSize:s}){Ms(i.camera,o,s,t,r),i.pathTracer.updateCamera(),i.pathTracer.reset(),i.denoisePipeline.reset(),Os({lastPublishedSampleCounterTextRef:e,maxSamples:n,sampleCount:0,sampleCounterRef:a})}function Ms(e,t,n,r,i){lo({camera:e,leftPanelOcclusionWidth:r,rightPanelOcclusionWidth:i,snapshot:t,viewportSize:n})}function Ns(e){e.scene.updateMatrixWorld(!0),e.pathTracer.setScene(e.scene,e.camera),e.pathTracer.reset(),e.denoisePipeline.reset()}function Ps(e,t,n){if(!es({enabled:$.denoise.enabled&&t,maxSamples:n,sampleCount:e.pathTracer.samples}))return{texture:e.pathTracer.target.texture};let r=e.denoisePipeline.render({camera:e.camera,inputTexture:e.pathTracer.target.texture,renderer:e.renderer,scene:e.scene});return{denoiseStatus:r.status===`denoised`?`denoised`:`not-denoised-error`,texture:r.texture}}export{Ds as PathTracingCanvas,Ds as default};